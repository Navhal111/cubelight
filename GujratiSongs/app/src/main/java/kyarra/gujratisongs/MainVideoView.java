    ...
    //                        String string_path = ;
        ...
        private boolean downloadFromUrl(String youtubeDlUrl, String downloadTitle, String fileName) {
            ...
            request.setTitle("Morari Bapu");

            request.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
            File downloadfolder = new File(Environment.getExternalStorageDirectory(), "MorariBapu");
    //        File downloadfolder = new File(Environment.getExternalStorageDirectory() +
    //                File.separator + "SadStatus");
            if (!downloadfolder.exists()){
                downloadfolder.mkdirs();
            }
            request.setDestinationInExternalPublicDir("MorariBapu", fileName);
